...
export default function HomePage() {
  return (
    <main style={{ minHeight: "100vh", background: "#050505", color: "#f5f2ec" }}>
      <style>{`
        .home-shell { max-width: 1320px; margin: 0 auto; padding: 36px 22px 84px; display:grid; gap:24px; }
        .home-card { border:1px solid rgba(255,255,255,0.08); background:linear-gradient(180deg, rgba(255,255,255,0.03), rgba(255,255,255,0.015)); }
        ...
        .home-bubble { padding:14px 16px; border:1px solid rgba(255,255,255,0.08); line-height:1.66; backdrop-filter:blur(8px); }
        ...
        .home-chip { display:inline-flex; padding:8px 10px; border:1px solid rgba(255,255,255,0.08); background:rgba(255,255,255,0.03); font-size:12px; color:rgba(245,242,236,0.72); }
        .home-grid { display:grid; grid-template-columns: repeat(3, minmax(0,1fr)); gap:18px; }
        .home-step { padding:18px; border:1px solid rgba(255,255,255,0.08); background:rgba(255,255,255,0.02); line-height:1.68; }
      ...
      <div className="home-shell">
        <section className="home-hero">
          <div className="home-card" style={{ padding: 26, display: "grid", gap: 20, alignContent: "start" }}>
          ...
          <section className="home-card home-stage">
            ...
            <div className="home-summary">
              <div className="home-card" style={{ padding: 16, display: "grid", gap: 10 }}>
        ...
        <section className="home-grid">
          <article className="home-card" style={{ padding: 20, display: "grid", gap: 12 }}>
