...
export default function WorkspaceClarityV2Page() {
                ...
                <div key={participant.id} className='card participant'>
                  ...
                  <div className='meter'>
                    <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12 }}>
                      <span className='muted'>Ease</span>
                      <span>{percent(participant.current_state.openness)}</span>
                    </div>
                    <div className='meterbar'>
                      <div className='meterfill' style={{ width: percent(participant.current_state.openness) }} />
                    </div>
                  </div>
                  <div className='meter'>
                    <div style={{ display: 'flex', justifyContent: 'space-between', gap: 12 }}>
                      <span className='muted'>Calm</span>
                      <span>{percent(participant.current_state.steadiness)}</span>
                    </div>
                    <div className='meterbar'>
                      <div className='meterfill' style={{ width: percent(participant.current_state.steadiness) }} />
                    </div>
                  </div>
                </div>
              ))}
