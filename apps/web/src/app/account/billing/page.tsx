  ...
  if (!user) {
    return (
      <AppShell
        ...
        description="Select a group of levels that fits your situation."
      >
         <div style={{ marginTop: 24, padding: 32, border: "1px solid var(--color-border)", borderRadius: "var(--radius-lg)", background: "rgba(6, 7, 10, 0.4)", backdropFilter: "blur(20px)" }}>
           <h3 style={{ margin: 0, fontSize: 18, fontWeight: 400, color: "var(--color-text-primary)" }}>Start with a message</h3>
           <p style={{ margin: "6px 0 16px 0", fontSize: 14, color: "var(--color-text-secondary)", lineHeight: 1.6 }}>Access to DEFRAG requires an account. Create your workspace to see your conversations and select a tier.</p>
    ...
    >
      <div className="premium-fade-up" data-delay="1" style={{ display: "grid", gap: 48, marginTop: 24 }}>
            ...
            <div style={{ display: "grid", gap: 8 }}>
              <div style={{ fontSize: 32, fontWeight: 400, color: "var(--color-text-primary)", letterSpacing: "-0.02em", display: "flex", alignItems: "center", gap: 12 }}>
                {activePlanKey === "realtime" ? "Studio+" :
                 ...
                 {isSubscribed && <span style={{ padding: "4px 8px", borderRadius: "var(--radius-pill)", background: "rgba(239, 68, 68, 0.1)", color: "var(--color-accent)", fontSize: 10, letterSpacing: "0.14em", textTransform: "uppercase" }}>Active</span>}
              </div>
        ...
        <section style={{ display: "grid", gap: 32, paddingTop: 40, borderTop: "1px solid var(--color-border)" }}>
           <div style={{ fontSize: 11, letterSpacing: "0.2em", textTransform: "uppercase", color: "var(--color-text-muted)" }}>Pricing</div>
           ...
           <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 40 }}>
              <div style={{ display: "grid", gap: 12 }}>
                 ...
                 <p style={{ margin: 0, color: "var(--color-text-secondary)", lineHeight: 1.6, fontSize: 14 }}>
                    Standard tracking. Perfect for mapping scattered interactions and basic context building.
                 </p>
              </div>
              ...
              <div style={{ display: "grid", gap: 12, opacity: activePlanKey === "core" || activePlanKey === "studio" ? 0.4 : 1 }}>
                 ...
                 <p style={{ margin: 0, color: "var(--color-text-secondary)", lineHeight: 1.6, fontSize: 14 }}>
                    Unlimited insight processing. Access structured interpretation panels and next-move simulations.
                 </p>
              </div>
              ...
              <div style={{ display: "grid", gap: 12, opacity: activePlanKey === "studio" ? 0.4 : 1 }}>
                 ...
                 <p style={{ margin: 0, color: "var(--color-text-secondary)", lineHeight: 1.6, fontSize: 14 }}>
                    Deep temporal analysis. Retain extended interaction history and identify long-term patterns.
                 </p>
              </div>
           </div>
        </section>
